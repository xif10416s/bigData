...
public class UserCreditLogSchemaLoader implements SchemaLoader, Serializable {
	...
	public void loadSchema(JavaSparkContext ctx, JavaSQLContext sqlCtx) {
		System.out.println("=== Data source: UserCreditLogSchemaLoader RDD ===");
		// Load a text file and convert each line to a Java Bean.
		JavaRDD<UserCreditLog> userCredit = ctx.textFile(
				"C:/Users/fxi/Documents/20150319/20150319/hq_user_credit_log_2015_03_19.csv").map(
				new Function<String, UserCreditLog>() {
					@Override
					public UserCreditLog call(String line) {
						...
						if(parts.length >19 && parts[18].length() == 32) {
							...
							userCreditLog.setCommodityType(Utils.valueOf(parts[7]));
